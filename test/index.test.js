...
test("98,738,729 -> 98.7 million, precision 3, no decimal", () => {
  expect(readableNum(98738729)).toBe("99 million");
});

test("98,738,729 -> 98.7 million, precision 3, allow decimal", () => {
  expect(readableNum(98738729, { allowDecimal: true })).toBe("98.7 million");
});
...
test("128,738,729 -> 129 million, precision 4, allow decimal", () => {
  expect(readableNum(128738729, { precision: 4, allowDecimal: true })).toBe("128.7 million");
});
